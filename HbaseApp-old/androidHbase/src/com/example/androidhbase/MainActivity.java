package com.example.androidhbase;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				webView.setWebViewClient(new WebViewClient());
				webView.loadUrl("http://134.193.136.114:8181/HBaseWS/jaxrs/generic/hbaseCreate/TableGRP4/Date:Acc:GPS");
			}
		...
		button5.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				webView.setWebViewClient(new WebViewClient());
				webView.loadUrl("http://134.193.136.114:8181/HBaseWS/jaxrs/generic/hbaseInsert/TableGRP4/-home-cloudera-GPS_Grp4.txt/Date:Acc:GPS");
			}
		...
		button6.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				webView.setWebViewClient(new WebViewClient());
				webView.loadUrl("http://134.193.136.114:8181/HBaseWS/jaxrs/generic/hbaseRetrieveAll/TableGRP4");
			}
		...
		button7.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				webView.setWebViewClient(new WebViewClient());
				webView.loadUrl("http://134.193.136.114:8181/HBaseWS/jaxrs/generic/hbasedeletel/TableGRP4");
			}
